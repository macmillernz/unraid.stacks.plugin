(function ($) {
  ...
  // if something left a hint behind (e.g. a just-created stack). Cleared
  // immediately after use so it only applies once, not on every later
  // visit/refresh of this page.
